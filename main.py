# THE READER FOR PDF FILES (for dealing with messy resume formats)
import fitz
...
try:
    resume_text = extract_text_from_pdf("candidate_resume.pdf")   # Replace with your resume file path
